...
:::note[Outlines]
If you require a hollow rectangle (borders only), use [`ui.drawRect`](../draw-rect/) instead.
:::
...
| `roundingFlags` | [`ui.CornerFlags`](../enums/#uicornerflags) | No       | `All`   | Bitmask determining which corners are rounded. |
