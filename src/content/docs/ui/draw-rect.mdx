...
This function renders a hollow rectangle.
...
If you require a solid shape, use [`ui.drawRectFilled`](/ui/draw-rect-filled/) instead.
:::
...
| `roundingFlags` | [`ui.CornerFlags`](/ui/enums/#uicornerflags) | No       | `ui.CornerFlags.All` | Bitmask determining which corners apply the rounding radius. |
