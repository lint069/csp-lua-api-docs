...
This guide describes how to contribute documentation to this project, it applies to all changes submitted.
...
Asides (Astro/Starlight callouts) should be used sparingly and only when they add value.
...
Contributions are reviewed for accuracy, consistency, and fit with the existing documentation style. Changes may be requested before merging.
